...
class EVCSVisualizer:
    ...
    def plot_convergence(self, convergence_history: List[Dict], output_path: str = "convergence_curve.png"):
        ...
        # Add an extra subplot to show queue waiting time evolution
        ...
        # 5. Queue Wait Time (minutes) evolution
        if 'avg_wait_min' in history_df.columns:
            ...
            # If we recorded unstable site counts (infinite waits), plot that on a secondary axis
